        ...
        <Container>
          <div className="grid lg:grid-cols-3 gap-6">
            <Reveal className="lg:col-span-2">
              <div className="h-full grid md:grid-cols-2 bg-card border border-border/70 rounded-sm overflow-hidden">
                <img src={teaPartyPhoto} alt="A themed tea party table" className="w-full h-full object-cover min-h-[260px]" loading="lazy" />
